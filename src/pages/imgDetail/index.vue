                ...
                <view class="comment_item" v-for="item in hot" :key="item.id">
                    ...
                    <view class="comment_user">
                        ...
                        <view class="user_name">
                            ...
                            <view class="user_time">{{item.cnTiem}}</view>
                        </view>
                        <!-- 用户徽章 -->
                        <view class="user_badge">
                            <image :src="imgItem.icon" 
                                v-for="imgItem in item.user.title" 
                                :key="imgItem.icon"></image>
                        </view>
                    </view>
                    <!-- 评论数据 -->
    ...
    methods:{
        ...
        getComments(id){
            this.request({
                ...
                //给hot、comment数组中的对象添加一个时间属性xxx月前
                result.res.hot.forEach(
                    v=>(v.cnTiem=moment(v.atime*1000).fromNow())
                );
